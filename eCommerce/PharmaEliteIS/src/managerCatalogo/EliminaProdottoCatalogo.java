...
/**
 * Servlet implementation class EliminaProdottoCatalogo
 */
@WebServlet("/EliminaProdottoCatalogo")
public class EliminaProdottoCatalogo extends HttpServlet {
	 ...
	 */
	public EliminaProdottoCatalogo() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		gestore.eliminaProdottoCatalogo(id);
