<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="managerUtente.ClienteBean, managerUtente.DatiAnagraficiBean,managerUtente.IndirizzoDiSpedizioneBean"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<body>
	...
	//	TelefonoBean telefono = (TelefonoBean) request.getAttribute("telefono");
		IndirizzoDiSpedizioneBean indirizzo = (IndirizzoDiSpedizioneBean) request.getAttribute("indirizzo");
	%>
